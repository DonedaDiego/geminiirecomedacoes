...
def process_payment(payment_id):
    """
    Processa um pagamento - VERSÃO CORRIGIDA FINAL
    Atualiza os campos CORRETOS: plan_id e plan_name
    """
    try:
        ...
        print(f"📦 Plano determinado: {plan_name} (ID numérico: {plan_id_numeric})")
